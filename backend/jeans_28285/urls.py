...
admin.site.site_header = "jeans"
admin.site.site_title = "jeans Admin Portal"
admin.site.index_title = "jeans Admin"

# swagger
api_info = openapi.Info(
    title="jeans API",
    default_version="v1",
    description="API documentation for jeans App",
)
